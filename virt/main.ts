...
import { assert, codebaseRoot, file_io, parseCpuset, splitVbar, Yargs, YargsCoercedArray } from "../util/mod.js";
import { VirtComposeContext, type VMNetwork, type VMOptions } from "./context.js";

const args = Yargs()
  .option("vm", YargsCoercedArray({
    coerce(line): VMOptions & { place: compose.PlaceRule } {
